...
def calculate_angle_force_constant(hessian, coordinates, idx1, idx2, idx3):
    ...
    bohr_to_angstrom = 0.529177
    k_theta_kcal_rad = k_theta * hartree_to_kcal_mol * (bohr_to_angstrom ** 2)
...
def get_atom_signature(atom, atomic_numbers, connectivity, rings, charges, charge_tolerance=0.02):

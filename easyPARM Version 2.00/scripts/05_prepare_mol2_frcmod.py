...
def get_counter_for_metal(metal_index, atom_type):
    if metal_index == 0:
        ...
        return iter(list(range(0, 10)) + list('abcdefghijk'))
    elif metal_index == 1:
        ...
        if atom_type.isupper():
            # Reverse alphabetical lowercase: z through m
            return iter("zyxwvutsrqponm")
        else:
            # Reverse alphabetical uppercase: Z through M
            return iter("ZYXWVUTSRQPONM")
    elif metal_index == 3:
